...
const Footer = () => {
  return (
    <div>
    <div className=' max-w-[1240px]  grid lg:grid-cols-3 gap-x-20 gap-y-4 font-montserrat'>
        <div className='px-4'>
            <h1 className='text-3xl text-blue-500 '>My Personal Website</h1>
            <h3 className=' text-[#737373] text-xl'>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Quaerat dignissimos culpa voluptatem autem accusamus officiis sit nesciunt consequatur obcaecati suscipit corrupti facilis deleniti, eligendi nobis qui error harum mollitia dolores.</h3>
        </div>

        <div className='lg:col-span-1 flex justify-between mx-right grid-cols-2 gap-10'>
            <div className='ml-40'>
  ...
  <footer className="footer  mx-auto text-neutral-content ">
